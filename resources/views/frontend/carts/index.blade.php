						...
						<div class="row">
							<div class="col-md-5 ml-auto">
								<div class="cart-page-total">
									<h2>Cart totals</h2>
									<ul>
										<li>Total price<span>Rp{{ Cart::subtotal(0, ",", ".") }}</span></li>
										<!-- <li>Total<span>Rp{{ Cart::total(0, ",", ".") }}</span></li> -->
										<li>Payment</li>
										<input type="number" class="form" name="payment" value="{{ old('payment') }}" id="payment">

										<li>Exchange<span>Rp{{ Cart::subtotal(0, ",", ".")}}</span></li>

									</ul>
									<a href="{{ url('orders') }}">Proceed to checkout</a>
								</div>
							</div>
						</div>
                        </form>
